        ...
        <div class="container">
            <div class="login-container">
                <div class="login-left">
                    <h2 style="font-size: 2.5rem; font-weight: 700; margin-bottom: 1.5rem;">Create New Password</h2>
                    <p style="font-size: 1.2rem; margin-bottom: 2rem; opacity: 0.9;">
                        Choose a strong password to secure your account.
                    </p>
                    <div style="margin-top: 2rem;">
                        <div style="display: flex; align-items: center; margin-bottom: 1.5rem;">
                            <i class="fas fa-lock" style="font-size: 1.5rem; margin-right: 1rem;"></i>
                            <div>
                                <h4 style="margin-bottom: 0.3rem;">Strong Security</h4>
                                <p style="opacity: 0.8;">Use a combination of letters, numbers & symbols</p>
                            </div>
                        </div>
                        <div style="display: flex; align-items: center; margin-bottom: 1.5rem;">
                            <i class="fas fa-shield-alt" style="font-size: 1.5rem; margin-right: 1rem;"></i>
                            <div>
                                <h4 style="margin-bottom: 0.3rem;">Account Protection</h4>
                                <p style="opacity: 0.8;">Your new password will keep your account safe</p>
                            </div>
                        </div>
                        <div style="display: flex; align-items: center;">
                            <i class="fas fa-check-circle" style="font-size: 1.5rem; margin-right: 1rem;"></i>
                            <div>
                                <h4 style="margin-bottom: 0.3rem;">Instant Access</h4>
                                <p style="opacity: 0.8;">Start using your account immediately after reset</p>
                            </div>
                        </div>
                    </div>
                </div>
