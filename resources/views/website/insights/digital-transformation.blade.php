...
@push('meta')
<title>Digital Transformation in Education with Skoolyst | SKOOLYST Insights</title>
<meta name="description" content="Discover how Skoolyst is transforming Pakistan's education system with smart school discovery, transparent reviews, and digital learning support for schools, parents and students.">
<link rel="canonical" href="{{ url()->current() }}">
<meta property="og:type" content="article">
<meta property="og:site_name" content="SKOOLYST Pakistan">
<meta property="og:title" content="Digital Transformation in Education with Skoolyst | SKOOLYST Insights">
<meta property="og:description" content="Discover how Skoolyst is transforming Pakistan's education system with smart school discovery, transparent reviews, and digital learning support.">
<meta property="og:url" content="{{ url()->current() }}">
<meta property="og:image" content="{{ asset('assets/assets/hero1.png') }}">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@skoolystpk">
<meta name="twitter:title" content="Digital Transformation in Education with Skoolyst | SKOOLYST Insights">
<meta name="twitter:description" content="How Skoolyst helps schools, parents and students move towards a smarter, connected education system in Pakistan.">
<meta name="twitter:image" content="{{ asset('assets/assets/hero1.png') }}">
<script type="application/ld+json">
{!! json_encode([
    '@context' => 'https://schema.org',
    '@type' => 'Article',
    'headline' => 'Digital Transformation in Education with Skoolyst',
    'description' => "How Skoolyst is transforming Pakistan's education system with smart school discovery, transparent reviews, and digital learning support.",
    'url' => url()->current(),
...
{!! json_encode([
    ...
    'itemListElement' => [
        ...
        ['@type' => 'ListItem', 'position' => 3, 'name' => 'Digital Transformation in Education', 'item' => url()->current()],
    ],
], JSON_UNESCAPED_SLASHES | JSON_PRETTY_PRINT) !!}
</script>
@endpush
