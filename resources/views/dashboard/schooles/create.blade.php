                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                @include('dashboard.schooles.partials.curriculum-selector', [
                                    'selectedCurriculumIds' => old('curriculum_ids', []),
                                ])
                            </div>
                            ...
                            <div id="fixed_fee_structure_create" class="fee-structure-section bg-light p-3 rounded mb-3" style="{{ old('fee_structure_type', 'fixed') == 'fixed' ? '' : 'display:none;' }}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="admission_fees_fixed" name="admission_fees"
                                            placeholder="e.g., PKR 15,000 – PKR 25,000" maxlength="255"
                                            value="{{ old('admission_fees') }}">
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function createCwRow(idx, range, amount) {
            ...
            row.innerHTML =
                ...
                '<input type="text" class="form-control class-range" name="class_wise_fees[' + idx + '][range]" maxlength="35" placeholder="e.g., KG to 1" value="' + escHtml(range) + '" required></div>' +
                '<div class="col-md-5 mb-2"><label class="form-label">Fees</label>' +
                '<input type="text" class="form-control fees-amount" name="class_wise_fees[' + idx + '][amount]" maxlength="35" placeholder="e.g., 1000" value="' + escHtml(amount) + '" required></div>' +
