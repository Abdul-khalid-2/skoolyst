            ...
            <div class="row">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select class="form-select @error('status') is-invalid @enderror"
                                            ...
                                            <option value="active" {{ old('status', $testType->status->value) == 'active' ? 'selected' : '' }}>Active</option>
                                            <option value="inactive" {{ old('status', $testType->status->value) == 'inactive' ? 'selected' : '' }}>Inactive</option>
                                        </select>
                                        @error('status')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                ...
                <div class="col-lg-4">
                    <x-card>
                        ...
                        <div class="card-body">
                            <x-alert variant="warning" :icon="false" :dismissible="false" class="mb-0">
                            ...
                            <div class="mt-3">
                                ...
                                <ul class="list-group list-group-flush">
                                    ...
                                    <li class="list-group-item d-flex justify-content-between align-items-center px-0">
                                        <span>Subjects</span>
                                        <x-button href="{{ route('subjects.index', ['test_type_id' => $testType->id]) }}" variant="primary" class="btn-sm text-decoration-none">
                            ...
                            <x-alert variant="info" :icon="false" :dismissible="false" class="mt-3 mb-0">
