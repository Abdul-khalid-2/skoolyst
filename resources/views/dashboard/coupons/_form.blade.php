...
<div class="row">
    <div class="col-lg-8">
        <x-card class="mb-4">
            <x-slot name="cardHeader"><h5 class="mb-0">Coupon Details</h5></x-slot>
            <div class="row">
        ...
        <x-card class="mb-4" id="targetsCard">
            <x-slot name="cardHeader"><h5 class="mb-0">Coupon Targets</h5></x-slot>
    ...
    <div class="col-lg-4">
        <x-card class="mb-4">
            <x-slot name="cardHeader"><h5 class="mb-0">Scope &amp; Limits</h5></x-slot>
        ...
        <x-card class="mb-4">
            <x-slot name="cardHeader"><h5 class="mb-0">Validity</h5></x-slot>
            <div class="form-group">
        ...
        <x-card class="mb-4">
            <x-slot name="cardHeader"><h5 class="mb-0">Status</h5></x-slot>
