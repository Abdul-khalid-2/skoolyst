<x-app-layout>
    <main class="main-content">
        <section id="edit-product-category" class="page-section">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h2 class="h4 mb-0">Edit Category</h2>
                    <p class="mb-0 text-muted">Update category information</p>
                </div>
                <a href="{{ route('product-categories.show', $productCategory) }}" class="btn btn-secondary">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <label for="image" class="form-label">
                                                {{ $productCategory->image_url ? 'Change Image' : 'Upload Image' }}
                                            </label>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group mt-3">
                                            ...
                                            <input type="text" class="form-control @error('icon') is-invalid @enderror" 
                                                   id="icon" name="icon" value="{{ old('icon', $productCategory->icon) }}" 
                                        ...
                                        <div class="form-group mt-3">
                                            ...
                                            <input type="number" class="form-control @error('sort_order') is-invalid @enderror" 
                                                   id="sort_order" name="sort_order" value="{{ old('sort_order', $productCategory->sort_order) }}">
                                            @error('sort_order')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-check mt-3">
                                            <input type="checkbox" class="form-check-input" id="is_active" name="is_active" value="1" {{ old('is_active', $productCategory->is_active) ? 'checked' : '' }}>
                        ...
                        <div class="row mt-4">
                            <div class="col-12">
                                <div class="d-flex gap-2">
                                    ...
                                    <a href="{{ route('product-categories.show', $productCategory) }}" class="btn btn-secondary">Cancel</a>
                                </div>
                            </div>
                        </div>
                    </form>
